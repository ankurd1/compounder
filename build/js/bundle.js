...
var CompoundCalculatorInc = React.createClass({displayName: "CompoundCalculatorInc",
  ...
  render: function() {
    return (
      React.createElement("form", {classNameName: "form-horizontal"}, 
        React.createElement("div", {className: "form-group"}, 
          React.createElement("label", {className: "col-xs-4 control-label"}, "Initial amount"), 
...
var React = require("React");
var CompoundCalculatorInc = require("./compound-calculator-inc");

React.render(
  React.createElement(CompoundCalculatorInc, null),
  document.getElementById('left-box')
);

},{"./compound-calculator-inc":1,"React":157}],3:[function(require,module,exports){
/**
